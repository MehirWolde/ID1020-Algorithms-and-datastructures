...
README: A program based on DFS, in an undirected graph, which can answer questions of the type:
...
public class DepthFirstPaths {
    ...
    public DepthFirstPaths(Graph G, int s) {  //constructor to initiate an object of type depthfirstpaths
